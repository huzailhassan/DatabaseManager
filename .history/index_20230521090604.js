...
app.post('/request', (req, res) => {
  ...
  const request = { id: '32223444', type: 'idiot32', amount: '3444.22', amount2: '2333.3' };
  const request1 = Object.getOwnPropertyNames(request);
  const request2 = Object.values(request).map(value => `'${value}'`);
